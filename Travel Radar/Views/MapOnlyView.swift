...
struct MapOnlyView: View {
    @State var countryView: [String: any View] = ["UK" : UKMainView(), "US": UsaMainView(), "France": UKMainView(), "Spain": SpainMainView(), "Portugal": UKMainView(), "Ireland": UKMainView(), "Germany": GermanyMainView()]
