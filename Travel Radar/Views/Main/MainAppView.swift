...
final class MapViewModelView: ObservableObject{
    ...
    @Published var countryView: [String: any View] = ["UK" : UKMainView(), "US": UsaMainView(), "France": FranceMainView(), "Spain": SpainMainView(), "Portugal": PortugalMainView(), "Ireland": IrelandMainView(), "Germany": GermanyMainView(), "Brazil": BrazilMainView()]
    @Published var countryRusNames: [String] = ["Великобритания", "США", "Франция", "Испания", "Португалия", "Ирландия", "Германия", "Бразилия"]
